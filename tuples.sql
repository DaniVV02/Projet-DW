...
INSERT INTO Evenement VALUES (1, 'Tournoi', 4, 'Compétition internationale', 'Skin exclusif');
INSERT INTO Evenement VALUES (2, 'Mega pig', 7, 'Casser la tirelire dans un club', 'Skin legendaire');
INSERT INTO Evenement VALUES (3, 'Community event', 7, 'Faire 200000000 kills', 'Star drop legendaire');
INSERT INTO Evenement VALUES (4, 'Bob l eponge', 31, 'Nouveaux pouvoirs et skins de bob l eponge', 'Skins thématiques');
INSERT INTO Evenement VALUES (5, 'Double Stardrop Week-End', 3, 'Star drops doublée pendant le week-end', 'Recompenses classiques des star drops');
INSERT INTO Evenement VALUES (6, 'Anges vs Demons', 31, 'Nouveaux cosmétiques et modes de jeu ajoutés', 'Nouvelles skins');
INSERT INTO Evenement VALUES (7, 'Mega boites', 31, 'Faire des défis pour gagner des mega boites', 'Grosse récompense de boites');
INSERT INTO Evenement VALUES (8, 'Anniversaire du jeu', 24, 'Célébration de l’anniversaire du jeu', 'Star drops gratuits');
INSERT INTO Evenement VALUES (9, 'Godzilla', 31, 'Récompenses de fin de saison', 'Skins et gemmes');
INSERT INTO Evenement VALUES (10, 'Lancement de Nouveau Brawler', 14, 'Nouveau brawler disponible', 'Nouveau brawler');
INSERT INTO Evenement VALUES (11, 'Aucun', 0, 'Aucun', 'Aucun');
...
INSERT INTO Date_Achats VALUES (4, TO_DATE ('2024-07-15', 'YYYY-MM-DD') ,15, 07, 2024, 'Non', 'Ete');
...
INSERT INTO Session_Achats VALUES (5, 240, TO_DATE( '2024-11-10 20:00','YYYY-MM-DD HH24:MI'), 'Session Très Longue',150, 10, 500, 12, 3000, 0);
...
-- Ces insertions correespondent aux achats effectués
-- L'absence de quelques cles de sessions, produits, etc., veut dire que il n'y a pas eu d'achats

INSERT INTO Achats VALUES (12, 1, 6, 11, 6, 1, 11, 13, 1.95 , 2); --OK Joueur actif dans session 1 avenement anges et dem
INSERT INTO Achats VALUES (13, 1, 6, 11, 6, 1, 11, 12, 0.99 , 1); --OK Joueur actif dans session 1 evenement ang et dem
INSERT INTO Achats VALUES (6, 1, 6, 11, 6, 1, 10, 8, 3.99 , 1); --OK Joueur actif dans session 1 skin limite evenement ang et dem


INSERT INTO Achats VALUES (2, 4, 3, 11, 11, 3, 1, 5, 14.99, 1); --OK Joueur regulier dans session 3
INSERT INTO Achats VALUES (5, 4, 3, 7, 11, 3, 4, 12, 2.49, 1); --OK Joueur regulier dans session 3


INSERT INTO Achats VALUES (10, 4, 9, 1, 4, 10, 1, 5, 2.99, 1); --OK Joueur occasionnel dans session 10 
INSERT INTO Achats VALUES (3, 4, 9, 8, 4, 10, 7, 8, 6.99, 1); --OK Joueur occasionnel dans session 10 



INSERT INTO Achats VALUES (3, 10, 11, 8, 5, 6, 7, 12, 6.99, 1); --OK Joueur regulier dans session 6 pre evenement
INSERT INTO Achats VALUES (14, 10, 2, 11, 12, 7, 11, 13, 2.95, 3); --OK Joueur regulier dans session 7 pendant evenement
INSERT INTO Achats VALUES (1, 10, 2, 11, 12, 7, 4, 5, 9.99, 1); --OK Joueur regulier dans session 7 pendant evenement
INSERT INTO Achats VALUES (14, 10, 2, 11, 13, 12, 11, 7, 0.99, 1); --OK Joueur regulier dans session 12 pendant evenement
INSERT INTO Achats VALUES (5, 10, 11, 4, 14, 11, 4, 5, 2.49, 1); --OK Joueur regulier dans session 11 post evenement


--absence d'achats du joueur regulier pre evenement
INSERT INTO Achats VALUES (14, 2, 2, 11, 12, 13, 11, 8, 0.99, 1); --OK Joueur occasionnel dans session 7 pendant evenement
--absence d'achats du joueur regulier post evenement

--pendant evenement 
INSERT INTO Achats VALUES (4, 5, 6, 1, 1, 5, 8, 5, 12.99, 1); --OK Joueur payant dans session 5 brawl pass plus
INSERT INTO Achats VALUES (10, 5, 6, 1, 1, 5, 4, 8, 3.99, 1); --OK Joueur payant dans session 5 skin demon willow
INSERT INTO Achats VALUES (6, 5, 6, 1, 1, 5, 4, 9, 3.99, 1); --OK Joueur payant dans session 5 skin ange colt
INSERT INTO Achats VALUES (1, 5, 6, 3, 1, 5, 4, 9, 49.95, 5); --OK Joueur payant dans session 5 160 gemmes
INSERT INTO Achats VALUES (5, 5, 6, 4, 1, 5, 4, 9, 2.48, 1); --OK Joueur payant dans session 5 30 gemmes
INSERT INTO Achats VALUES (11, 5, 6, 4, 1, 5, 4, 9, 9.95, 1); --OK Joueur payant dans session 5 brawler nouveau
